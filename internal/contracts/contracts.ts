 ...
 */
export const KindLockup: Kind = "lockup";
/**
 ...
 * D-102.)
 */
export type AssetSide = string;
/**
 * LeadCaption places the caption then the logo (zero value).
 */
export const LeadCaption: AssetSide = "lead_caption";
/**
 * TrailCaption places the logo then the caption.
 */
export const TrailCaption: AssetSide = "trail_caption";
/**
